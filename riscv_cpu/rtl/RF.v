...
module RF(
    ...
    always @(posedge clk) begin
        if((WR != 0) && RFWrite) begin
            register[WR] <= WD;
            `ifdef DEBUG
                $display("R[00-07]=%8X %8X %8X %8X %8X %8X %8X %8X", r0, register[1], register[2], register[3], register[4], register[5], register[6], register[7]);
    ...
    assign RD1 = (RR1 == 0) ? r0 : register[RR1];
    assign RD2 = (RR2 == 0) ? r0 : register[RR2];
endmodule