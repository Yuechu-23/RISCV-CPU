...
`define INSTR_LUI_OP   7'b0110111
`define INSTR_AUIPC_OP 7'b0010111
...
`define INSTR_ANDI_FUNCT  3'b111
`define INSTR_XORI_FUNCT  3'b100
`define INSTR_SLTI_FUNCT  3'b010
`define INSTR_SLTIU_FUNCT 3'b011
`define INSTR_SLLI_FUNCT  3'b001
`define INSTR_SRLI_SRAI_FUNCT 3'b101

`define INSTR_BLT_FUNCT   3'b100
`define INSTR_BGE_FUNCT   3'b101
`define INSTR_BLTU_FUNCT  3'b110
`define INSTR_BGEU_FUNCT  3'b111

`define INSTR_LB_FUNCT    3'b000
`define INSTR_LH_FUNCT    3'b001
`define INSTR_LW_FUNCT    3'b010
`define INSTR_LBU_FUNCT   3'b100
`define INSTR_LHU_FUNCT   3'b101

`define INSTR_SB_FUNCT    3'b000
`define INSTR_SH_FUNCT    3'b001
`define INSTR_SW_FUNCT    3'b010

`define INSTR_SLT_FUNCT   10'b0000000_010
`define INSTR_SLTU_FUNCT  10'b0000000_011
